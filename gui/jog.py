...
class JogView(flet.Container):
    ...
    def __init__(self, uart_communicator, on_status_update=None, on_error=None):
        ...
        self.padding = 10 
        self.motors_list = ["J1", "J2", "J3", "J4", "J5", "J6"]
    ...
    def _setup_ui(self):
        ...
        self.lbl_speed = flet.Text(f"{self.speed_percent}%", size=18, weight="bold", color="cyan", max_lines=1)
        speed_panel = flet.Container(
            content=flet.Column([
                ...
                ], alignment="center", spacing=3, vertical_alignment=flet.CrossAxisAlignment.CENTER, tight=True)
        ...
        pos_list = flet.Column(spacing=4, horizontal_alignment="stretch", tight=True)
        ...
        for name in ["J1", "J2", "J3", "J4", "J5", "J6"]:
            ...
            pos_list.controls.append(flet.Row([flet.Text(f"{name}:", weight="bold", size=12), lbl], alignment="spaceBetween", tight=True))
    ...
    def _create_joint_control(self, display_name: str) -> flet.Container:
        ...
        if "gripper" in display_name.lower():
            ...
            return flet.Container(content=flet.Column([flet.Row([mk_btn("-", "minus", joint_code), flet.Text(display_name, size=20, weight="bold", color="white", text_align="center"), mk_btn("+", "plus", joint_code)], spacing=10, expand=True, vertical_alignment=flet.CrossAxisAlignment.CENTER, tight=True)], spacing=2), **container_style)
